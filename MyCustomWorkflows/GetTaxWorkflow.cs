...
namespace MyCustomWorkflows
{
    public class GetTaxWorkflow : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            QueryByAttribute query = new QueryByAttribute("crdb6_configuration");
            query.ColumnSet = new ColumnSet(new string[] { "crdb6_value"});
            query.AddAttributeValue("crdb6_name", key);
            ...
            Tax.Set(executionContext, config.Attributes["crdb6_value"].ToString());
        }
    }
}
